"""
EfficientNet-B5 Training Script
Pi et al. 2023 — best single model in ensemble
...
BEST_PATH   = "/kaggle/working/best_efficientnet_b5.pth"
NUM_CLASSES = 5
IMG_SIZE    = 456
BATCH_SIZE  = 16
EPOCHS      = 50
...
print(f"\nModel: EfficientNet-B5 | Input: {IMG_SIZE}x{IMG_SIZE}")
...
print("\n" + "="*60)
print("Training EfficientNet-B5")
print("="*60)
...
ax.set(xticks=range(NUM_CLASSES), yticks=range(NUM_CLASSES),
       ...
       title=f"EfficientNet-B5 | QWK={final_qwk:.4f}")
...
fig.tight_layout()
fig.savefig("/kaggle/working/confusion_matrix_efficientnet_b5.png", dpi=150)
plt.show()
